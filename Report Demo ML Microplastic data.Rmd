...
factoextra::fviz_pca_biplot(res.pca,  
                            ...
                            repel = TRUE,
                            labelsize = 6,
                            habillage = df_pca$Suspected_Polymer,
                            addEllipses = TRUE,
                            ggtheme = ggplot2::theme_minimal(base_size = 15),
                            title = "Polymer type")
...
for (ele in 1:95) {
  ...
  sig_comp_CO1_95[[paste0("Cut height_", ele)]] <- sp_df %>%
    filter(., adjusted_pvalue_holm < 0.05) %>%
    arrange(adjusted_pvalue_holm)
...
# writexl::write_xlsx(x = sig_comp_CO1_95, path = "Wilcoxon_test_HPLC_by_Robust Aichitson_HCA clustering result_CO1-79_zeroimputed_18Jan2024.xlsx")
```
